...
func NewMsgCommitment(creator string, from string, coinA string, toATimelock string, blockheight string, toBHashlock string, hashcode string, coinlock string) *MsgCommitment {
